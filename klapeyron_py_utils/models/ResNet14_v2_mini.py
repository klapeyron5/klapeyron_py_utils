...
class ResNet14_v2_mini(Base):
    ...
    NAME = 'ResNet14_v2_mini'

    def __init__(self, model_config: Model_Config, train_config: Model_Train_Config):
        super(ResNet14_v2_mini, self).__init__(model_config, train_config)

        self.input_shape = model_config.input_shape

        self.conv0 = Layer_conv_bn_relu((7, 7, self.input_shape[-1], 3), 2)

        Ns = [2, 2, 2]
        blocks_output_depths = [3, 6, 12]
